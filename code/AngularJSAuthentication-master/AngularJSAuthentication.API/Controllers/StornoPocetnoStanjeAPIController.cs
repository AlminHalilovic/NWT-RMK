...
namespace AngularJSAuthentication.API.Controllers
{
    ...
    public class StornoPocetnoStanjeAPIController : ApiController
    {
        ...
        {
            int vrsta = vrsteController.getIdBySifra("SPS");
        ...
        public string Postdp_ulazi()
        {
            ...
            else
            {
                ...
                ulaz.VRSTA_DOKUMENTA = vrsteController.getIdBySifra("SPS");
                ...
                else
                {
                    ...
                    brojac_dokumenata.VRSTA_DOKUMENTA = vrsteController.getIdBySifra("SPS");
