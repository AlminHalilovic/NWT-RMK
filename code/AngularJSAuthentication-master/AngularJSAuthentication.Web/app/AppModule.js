...
//Defining Translations
    app.config(function ($translateProvider) {
        $translateProvider.translations('en', {
            ...
            dokumentiTableBrojStornoPrimke: 'Cancellation receipt number',
            dokumentiTableDatumStornoPrimke: 'Cancellation receipt date',
            ...
            indexRoles: 'Roles',
            indexAddRole: 'Add role',
            indexRoleName: 'Role name',
            indexRoleEdit: 'Edit',
            indexRoleDelete: 'Delete',
            editRoleTitle: 'Edit role',
            editRoleRoleName: 'Role name',
            editRoleEdit: 'Save',
            editRoleCancel: 'Cancel',
            deleteRoleTitle: 'Delete role',
            deleteRoleRoleName: 'Role name',
            deleteRoleDelete: 'Delete',
            deleteRoleCancel: 'Cancel',
            addRoleToUserTitle: 'Add new role for user',
            addRoleToUserRoleName: 'Role name',
            addRoleToUserStatus: 'Status',
            addRoleToUserSave: 'Save',
            addRoleToUserCancel: 'Cancel',
            addRoleTitle: 'Add new role',
            addRoleRoleName: 'Role name',
            addRoleSave: 'Save',
            addRoleCancel: 'Cancel',
            indexUsers: 'Users',
            indexAddUser: 'Add user',
            indexUsername: 'Username',
            indexEmail: 'Email',
            indexBanned:'Banned',
            indexEditUser: 'Edit',
            indexDeleteUser: 'Delete',
            indexUsersAddRole: 'Add roles to user',
            ...
            deletUserUsername: 'Username',
            deleteUserDelete: 'Delete',
            ...
            indexRoles: 'Role',
            indexAddRole: 'Dodaj rolu',
            indexRoleName: 'Naziv role',
            indexRoleEdit: 'Ažuriranje',
            indexRoleDelete: 'Brisanje',
            editRoleTitle: 'Ažuriranje role',
            editRoleRoleName: 'Naziv role',
            editRoleEdit: 'Sačuvaj',
            editRoleCancel: 'Otkaži',
            deleteRoleTitle: 'Brisanje role',
            deleteRoleRoleName: 'Naziv role',
            deleteRoleDelete: 'Obriši',
            deleteRoleCancel: 'Otkaži',
            addRoleToUserTitle: 'Dodavanje nove role za korisnika',
            addRoleToUserRoleName: 'Naziv role',
            addRoleToUserStatus: 'Status',
            addRoleToUserSave: 'Sačuvaj',
            addRoleToUserCancel: 'Otkaži',
            addRoleTitle: 'Dodavanje nove role',
            addRoleRoleName: 'Naziv role',
            addRoleSave: 'Sačuvaj',
            addRoleCancel: 'Otkaži',
            indexUsers: 'Korisnici',
            indexAddUser: 'Dodaj korisnika',
            indexUsername: 'Korisničko ime',
            indexEmail: 'Email',
            indexBanned:'Banovan',
            indexEditUser: 'Ažuriranje',
            indexDeleteUser: 'Brisanje',
            indexUsersAddRole: 'Dodavanje nove role korisniku',
            editUserTitle: 'Ažuriranje korisnika',
            editUserUsername: 'Korisničko ime',
            editUserEmail: 'Email',
            editUserCurrentPassword: 'Trenutna lozinka',
            editUserPassword: 'Nova lozinka',
            editUserSave: 'Sačuvaj',
            editUserCancel: 'Otkaži',
            deleteUserTitle: 'Brisanje korisnika',
            deletUserUsername: 'Korisničko ime',
            deleteUserDelete: 'Obriši',
            deleteUserCancel: 'Otkaži',
            addUserTitle: 'Dodavanje novog korisnika',
            addUserUsername: 'Korisničko ime',
            addUserEmail: 'Email',
            addUserPassword: 'Lozinka',
            addUserSave: 'Sačuvaj',
            addUserCancel: 'Otkaži',
            adminDijagramiUsers: 'Korisnici',
